...
tm <- paste(as.character(household_data$Date), household_data$Time)     # Add the Date values to the Time column
...
y_lab <- "Frequency"
hist(household_data$Global_active_power, col = "red", main = ttl, xlab = x_lab, ylab = y_lab)
