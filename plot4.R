...
par(mfcol = c(2,2))                                                     # Layout the four plots
x <- household_data$Time

# First Plot
y <- household_data$Global_active_power
plot(x, y, xlab = "", ylab = "Global Active Power", type = "n")
lines(x, y)
...
# Third Plot
y <- household_data$Voltage
plot(x, y, xlab = "datetime", ylab = "Voltage", type = "n")
lines(x, y)

# Fourth Plot
y <- household_data$Global_reactive_power
plot(x, y, xlab = "datetime", ylab = "Global_reactive_power", type = "n")
lines(x, y)
